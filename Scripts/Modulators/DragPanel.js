namespace DragPanel
{
	const var ModDragPanel = Content.getComponent("ModDragPanel");
	
	ModDragPanel.data.sources = matrix.getSourceList();
	...
	{
		local c = Rect.reduced(obj.area, obj.valid ? 2 : 8);
	...
	ModDragPanel.setPaintRoutine(function(g)
	{
	...
	ModDragPanel.set("allowCallbacks", "All Callbacks");
	...
	ModDragPanel.setMouseCursor("PointingHandCursor", Colours.white, [0, 0]);
	
	ModDragPanel.data.hoverIndex = -1;
	
	ModDragPanel.setMouseCallback(function(event)
	{
