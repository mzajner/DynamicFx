...
gain = 1;
freq = hslider("[1]Grain Size[style:knob][acc:2 0 -10 0 10]", 200,5,2200,1);
...
proba = hslider ("[3]Probability[unit:%][style:knob][acc:1 0 -10 0 10]", 70,20,100,1) * (0.01):fi.lowpass(1,1);
