...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _QuadraticDistortion -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
class _QuadraticDistortion final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _QuadraticDistortion -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	_QuadraticDistortion* clone() {
		return new _QuadraticDistortion();
	}
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = fConst2 * std::max<float>(2e+01f, std::min<float>(2e+02f, float(fHslider0)));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp3 = float(input0[i0]) * fTemp2;
			...
			float fTemp9 = float(input1[i0]) * fTemp2;
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _QuadraticDistortion -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
