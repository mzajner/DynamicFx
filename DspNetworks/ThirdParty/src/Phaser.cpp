...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _Phaser -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
class _Phaser final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _Phaser -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = ((int(float(fCheckbox1))) ? 2.0f : std::max<float>(0.0f, std::min<float>(1.0f, float(fHslider1))));
		float fSlow3 = 0.5f * fSlow2;
		float fSlow4 = 1.0f - fSlow3;
		float fSlow5 = std::max<float>(-0.999f, std::min<float>(0.999f, float(fHslider2)));
		float fSlow6 = std::exp(-(fConst1 * std::max<float>(1e+01f, std::min<float>(5e+03f, float(fHslider3)))));
		float fSlow7 = 2.0f * fSlow6;
		float fSlow8 = std::max<float>(1.1f, std::min<float>(4.0f, float(fHslider4)));
		float fSlow9 = fConst2 * fSlow8;
		float fSlow10 = std::max<float>(2e+01f, std::min<float>(5e+03f, float(fHslider5)));
		float fSlow11 = 6.2831855f * fSlow10;
		float fSlow12 = 3.1415927f * (fSlow10 - std::max<float>(fSlow10, std::max<float>(2e+01f, std::min<float>(1e+04f, float(fHslider6)))));
		float fSlow13 = fConst3 * std::max<float>(0.0f, std::min<float>(1e+01f, float(fHslider7)));
		float fSlow14 = std::sin(fSlow13);
		float fSlow15 = std::cos(fSlow13);
		float fSlow16 = _Phaser_faustpower2_f(fSlow6);
		float fSlow17 = fConst2 * _Phaser_faustpower2_f(fSlow8);
		float fSlow18 = fConst2 * _Phaser_faustpower3_f(fSlow8);
		float fSlow19 = fConst2 * _Phaser_faustpower4_f(fSlow8);
		float fSlow20 = ((int(float(fCheckbox2))) ? -0.5f * fSlow2 : fSlow3);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = float(input0[i0]);
			float fTemp1 = ((iSlow0) ? 0.0f : fTemp0);
			iVec0[0] = 1;
			fRec5[0] = fSlow14 * fRec6[1] + fSlow15 * fRec5[1];
			fRec6[0] = float(1 - iVec0[1]) + fSlow15 * fRec6[1] - fSlow14 * fRec5[1];
			float fTemp2 = fSlow11 - fSlow12 * (1.0f - fRec5[0]);
			float fTemp3 = fRec4[1] * std::cos(fSlow9 * fTemp2);
			fRec4[0] = fSlow1 * fTemp1 + fSlow5 * fRec0[1] + fSlow7 * fTemp3 - fSlow16 * fRec4[2];
			float fTemp4 = fRec3[1] * std::cos(fSlow17 * fTemp2);
			fRec3[0] = fRec4[2] + fSlow16 * (fRec4[0] - fRec3[2]) - fSlow7 * (fTemp3 - fTemp4);
			float fTemp5 = fRec2[1] * std::cos(fSlow18 * fTemp2);
			fRec2[0] = fRec3[2] + fSlow7 * (fTemp5 - fTemp4) + fSlow16 * (fRec3[0] - fRec2[2]);
			float fTemp6 = fRec1[1] * std::cos(fSlow19 * fTemp2);
			fRec1[0] = fRec2[2] + fSlow16 * (fRec2[0] - fRec1[2]) - fSlow7 * (fTemp5 - fTemp6);
			fRec0[0] = fRec1[2] + fSlow16 * fRec1[0] - fSlow7 * fTemp6;
			output0[i0] = FAUSTFLOAT(((iSlow0) ? fTemp0 : fSlow1 * fTemp1 * fSlow4 + fRec0[0] * fSlow20));
			float fTemp7 = float(input1[i0]);
			float fTemp8 = ((iSlow0) ? 0.0f : fTemp7);
			float fTemp9 = fSlow11 - fSlow12 * (1.0f - fRec6[0]);
			float fTemp10 = fRec11[1] * std::cos(fSlow9 * fTemp9);
			fRec11[0] = fSlow1 * fTemp8 + fSlow5 * fRec7[1] + fSlow7 * fTemp10 - fSlow16 * fRec11[2];
			float fTemp11 = fRec10[1] * std::cos(fSlow17 * fTemp9);
			fRec10[0] = fRec11[2] + fSlow16 * (fRec11[0] - fRec10[2]) - fSlow7 * (fTemp10 - fTemp11);
			float fTemp12 = fRec9[1] * std::cos(fSlow18 * fTemp9);
			fRec9[0] = fRec10[2] + fSlow16 * (fRec10[0] - fRec9[2]) - fSlow7 * (fTemp11 - fTemp12);
			float fTemp13 = fRec8[1] * std::cos(fSlow19 * fTemp9);
			fRec8[0] = fRec9[2] + fSlow7 * (fTemp13 - fTemp12) - fSlow16 * (fRec8[2] - fRec9[0]);
			fRec7[0] = fRec8[2] + fSlow16 * fRec8[0] - fSlow7 * fTemp13;
			output1[i0] = FAUSTFLOAT(((iSlow0) ? fTemp7 : fSlow1 * fTemp8 * fSlow4 + fRec7[0] * fSlow20));
			iVec0[1] = iVec0[0];
			fRec5[1] = fRec5[0];
			fRec6[1] = fRec6[0];
			fRec4[2] = fRec4[1];
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _Phaser -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
