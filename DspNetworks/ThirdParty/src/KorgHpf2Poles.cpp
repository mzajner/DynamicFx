...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _KorgHpf2Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
class _KorgHpf2Poles final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _KorgHpf2Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = fConst1 * std::max<float>(0.5f, std::min<float>(1e+01f, float(fHslider0)));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fRec0 = (fTemp0 + (fTemp5 - fTemp6 - fRec2[1]) / fTemp3 - fRec3[1]) / fTemp7;
			float fTemp8 = fTemp2 * ((fRec3[1] - (fRec2[1] - (fTemp6 + fTemp5)) / fTemp3) / fTemp7 - fRec1[1]) / fTemp3;
			...
			float fRec6 = (fTemp10 + (fTemp11 - fTemp12 - fRec8[1]) / fTemp3 - fRec9[1]) / fTemp7;
			float fTemp13 = fTemp2 * ((fRec9[1] - (fRec8[1] - (fTemp12 + fTemp11)) / fTemp3) / fTemp7 - fRec7[1]) / fTemp3;
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _KorgHpf2Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
