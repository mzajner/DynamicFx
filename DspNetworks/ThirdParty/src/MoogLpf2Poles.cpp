...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _MoogLpf2Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
class _MoogLpf2Poles final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _MoogLpf2Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = fConst2 * std::max<float>(0.707f, std::min<float>(25.0f, float(fHslider1)));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp6 = fTemp0 * ((float(input0[i0]) - fTemp1 * (0.16465649f * fRec1[1] + 0.082328245f * fRec2[1] * fTemp3 + 0.082328245f * (fTemp4 * fRec3[1] / fTemp2)) / fTemp2) / fTemp5 - fRec3[1]) / fTemp2;
			...
			float fTemp10 = fTemp0 * ((float(input1[i0]) - fTemp1 * (0.16465649f * fRec7[1] + 0.082328245f * fTemp3 * fRec8[1] + 0.082328245f * (fTemp4 * fRec9[1] / fTemp2)) / fTemp2) / fTemp5 - fRec9[1]) / fTemp2;
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _MoogLpf2Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
