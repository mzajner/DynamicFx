...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _OberheimLpf4Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___OberheimLpf4Poles_H__
#define  ___OberheimLpf4Poles_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS _OberheimLpf4Poles
#endif
...
static float _OberheimLpf4Poles_faustpower2_f(float value) {
	return value * value;
}

class _OberheimLpf4Poles final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _OberheimLpf4Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		m->declare("description", "Oberheim multi-mode, state-variable filter");
		m->declare("filename", "OberheimLpf4Poles.dsp");
	...
	_OberheimLpf4Poles* clone() {
		return new _OberheimLpf4Poles();
	}
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp6 = 1.0f - 0.33333334f * _OberheimLpf4Poles_faustpower2_f(fTemp5);
			float fTemp7 = fTemp0 * fTemp5 * fTemp6;
			float fRec0 = fRec3[1] + fTemp7;
			...
			float fTemp10 = 1.0f - 0.33333334f * _OberheimLpf4Poles_faustpower2_f(fTemp9);
			fRec1[0] = fRec1[1] + 2.0f * fTemp0 * fTemp9 * fTemp10;
			fRec2[0] = fTemp8 + fTemp9 * fTemp10;
			fRec3[0] = fRec3[1] + 2.0f * fTemp7;
			fRec4[0] = fTemp4 + fTemp5 * fTemp6;
			...
			float fTemp14 = 1.0f - 0.33333334f * _OberheimLpf4Poles_faustpower2_f(fTemp13);
			float fTemp15 = fTemp0 * fTemp13 * fTemp14;
			float fRec7 = fRec10[1] + fTemp15;
			...
			float fTemp18 = 1.0f - 0.33333334f * _OberheimLpf4Poles_faustpower2_f(fTemp17);
			fRec8[0] = fRec8[1] + 2.0f * fTemp0 * fTemp17 * fTemp18;
			fRec9[0] = fTemp16 + fTemp17 * fTemp18;
			fRec10[0] = fRec10[1] + 2.0f * fTemp15;
			fRec11[0] = fTemp12 + fTemp13 * fTemp14;
	...
	#define FAUST_FILE_NAME "OberheimLpf4Poles.dsp"
	#define FAUST_CLASS_NAME "_OberheimLpf4Poles"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _OberheimLpf4Poles -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
