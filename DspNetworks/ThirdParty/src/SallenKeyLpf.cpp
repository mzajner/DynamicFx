...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _SallenKeyLpf -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___SallenKeyLpf_H__
#define  ___SallenKeyLpf_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS _SallenKeyLpf
#endif
...
class _SallenKeyLpf final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("SallenKeyLpf.dsp/sallenKey2ndOrder:author", "Eric Tarr");
		m->declare("SallenKeyLpf.dsp/sallenKey2ndOrder:license", "MIT-style STK-4.3 license");
		m->declare("author", "Eric Tarr");
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _SallenKeyLpf -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		m->declare("filename", "SallenKeyLpf.dsp");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = fConst2 * std::max<float>(0.3f, std::min<float>(8.0f, float(fHslider1)));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp4 = fRec2[1] + 2.0f * fTemp3;
			float fRec0 = fRec1[1] + fTemp0 * fTemp4;
			fRec1[0] = fRec1[1] + 2.0f * fTemp0 * (fRec2[1] + fTemp3);
			fRec2[0] = fTemp4;
			output0[i0] = FAUSTFLOAT(fRec0);
			float fTemp5 = fTemp0 * (float(input1[i0]) - (fRec6[1] + fTemp1 * fRec7[1])) / fTemp2;
			float fTemp6 = fRec7[1] + 2.0f * fTemp5;
			float fRec5 = fRec6[1] + fTemp0 * fTemp6;
			fRec6[0] = fRec6[1] + 2.0f * fTemp0 * (fRec7[1] + fTemp5);
			fRec7[0] = fTemp6;
	...
	#define FAUST_FILE_NAME "SallenKeyLpf.dsp"
	#define FAUST_CLASS_NAME "_SallenKeyLpf"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _SallenKeyLpf -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
